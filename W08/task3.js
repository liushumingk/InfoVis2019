function main()
{
    ...
    var s0 = Math.round(((0.1 - 0.1) / 0.7) * 255);
    var s1 = Math.round(((0.2 - 0.1) / 0.7) * 255);
    var s2 = Math.round(((0.8 - 0.1) / 0.7) * 255);
    var s3 = Math.round(((0.5 - 0.1) / 0.7) * 255);
    ...
    {
        var id = faces[i];
        var S0 = scalars255[ id[0] ];
        var S1 = scalars255[ id[1] ];
        var S2 = scalars255[ id[2] ];
